...
> **Association:** University College Cork (UCC) — MSc Business Analytics | Module: IS6052 Predictive Analytics  
...
|---|---|---|---|---|
| 1 | Logistic Regression | 0.679 | **0.472** | **0.677** |
| 2 | Random Forest | 0.775 | 0.004 | 0.622 |
| 3 | Decision Tree | 0.718 | 0.460 | 0.630 |
| 4 | XGBoost | 0.647 | 0.521 | 0.654 |
| 5 | ANN (MLP) | 0.774 | 0.000 | 0.619 |
| 6 | Linear SVM | 0.834 | 0.417 | 0.741 |
...
| **4** | **Customer Churn Prediction ← You are here** | **Python · ML · SHAP · LIME** |
